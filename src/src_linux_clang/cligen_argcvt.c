...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, argKeys_ldmSjxOmtrgGS6fyrYn28Q)(tyObject_ArgcvtParams_QVcnYYRJHH6P2DXl8CegPg* a, NimStringDesc* argSep) {
	...
	result = (NimStringDesc*)0;
	{
		...
		memset((void*)T5_, 0, sizeof(tyArray_24KAM9afIUgUaqBaEBB6r9bg));
...
appendString((*s), ((NimStringDesc*) &TM_i653W4H9bwOcZkwSy9aRLBfg_7));
		n = ((NU8)(c));
		(*s) = addChar((*s), ((NimStringDesc*) &TM_i653W4H9bwOcZkwSy9aRLBfg_8)->data[(NI)((NU64)((NI)(n & ((NI) 240))) >> (NU64)(((NI) 4)))]);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nimEscape_9aWigKJHRj2F8BfGpWue9bNw)(NimStringDesc* s) {
	NimStringDesc* result;
	result = (NimStringDesc*)0;
	result = rawNewString(((NI) ((NI)((NI)((s ? s->Sup.len : 0) + ((NI) 2)) + (NI)((NU64)((s ? s->Sup.len : 0)) >> (NU64)(((NI) 2)))))));
...
break;
		...
		LA8_: ;
		{
			...
			memset((void*)T14_, 0, sizeof(tyArray_24KAM9afIUgUaqBaEBB6r9bg));

...
extern tyProc_aO673xGTLLxou7P7GxoCXA Dl_220635_;
extern tyProc_im9buRnIvptJfzdASYMEbBA Dl_220801_;
extern tyProc_9bXer9a4ps9aSGctILcxWReVw Dl_220630_;
extern tyProc_9cu0cWy2jNXKVhds9cs4T9a9cA Dl_221432_;
extern tyProc_hayl9b1HhJokJ1Zo9ctoglPg Dl_221434_;
extern tyProc_IwsYs9blTXXmAlfsBWq604w Dl_220818_;
extern TNimType NTI_UV3llMMYFckfui8YMBuUZA_;
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_4, "", 0);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_5, "\012Additional info: ", 18);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_6, "unknown OS error", 16);
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_jvWQYw9bcuYhftfPX2ynPeg_7 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_8, "\"", 1);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_9, "\\\"", 2);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_10, ":\\", 2);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_11, "\\", 1);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_12, ".", 1);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_13, "..\\", 3);
static N_NIMCALL(void, Marker_tySequence_sM4lkSb7zS6F7OVMvW9cffQ)(void* p, NI op) {
...
N_LIB_PRIVATE N_NIMCALL(void, nossplitFile)(NimStringDesc* path, tyTuple_7q7q3E6Oj24ZNVJb9aonhAg* Result) {
	genericReset((void*)Result, (&NTI_7q7q3E6Oj24ZNVJb9aonhAg_));
	{
		...
		unsureAsgnRef((void**) (&(*Result).Field1), copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4)));
		unsureAsgnRef((void**) (&(*Result).Field2), copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4)));
	}
	goto LA1_;
	LA5_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, osErrorMsg_yWvWz5V6Ib7QshcAbOiDeQ)(NI32 errorCode) {
	...
	result = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4));
	{
		...
		msgbuf = (NI16*)0;
		{
			NI32 T7_;
			T7_ = (NI32)0;
			T7_ = Dl_220635_(((NI32) 4864), NIM_NIL, errorCode, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
			if (!!((T7_ == ((NI32) 0)))) goto LA8_;
			result = dollar__D2o4ABrO3iHTudww2CqX4w(msgbuf);
			{
				if (!!((msgbuf == NIM_NIL))) goto LA12_;
				Dl_220801_(((void*) (msgbuf)));
			}
			LA12_: ;
		}
		LA8_: ;
...
appendString(T6_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_5));
appendString(T6_, additionalInfo);
	...
	LA1_: ;
	{
		...
		T12_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_6));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nospquoteShellWindows)(NimStringDesc* s) {
	...
	result = (NimStringDesc*)0;
	T1_ = (NIM_BOOL)0;
	T1_ = contains_m1TSS3QwQPclQATuiRuVZg(s, TM_jvWQYw9bcuYhftfPX2ynPeg_7);
	if (T1_) goto LA2_;
	T1_ = ((s ? s->Sup.len : 0) == ((NI) 0));
	LA2_: ;
	needQuote = T1_;
	result = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4));
	backslashBuff = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4));
	{
		if (!needQuote) goto LA5_;
		result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_8));
	}
	LA5_: ;
	{
		NIM_CHAR c;
...
appendString(result, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_9));
				}
				goto LA10_;
				LA15_: ;
				{
...
appendString(T7_, val);
	...
	v = newWideCString_keidLK9c3HkgArW69bcHZYGA(val);
	{
		...
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T16_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4));
	}
	LA14_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, nossplitPath)(NimStringDesc* path, tyTuple_UV3llMMYFckfui8YMBuUZA* Result) {
	...
	LA10_: ;
	{
		unsureAsgnRef((void**) (&(*Result).Field0), copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4)));
...
appendString(T9_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_10));
			result = T9_;
		}
		goto LA5_;
		LA7_: ;
		{
			result = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_11));
		}
		LA5_: ;
		start = ((NI) 1);
	}
	...
	LA3_: ;
	{
		...
		LA13_: ;
		if (!T12_) goto LA14_;
		result = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_12));
		start = ((NI) 2);
	}
	goto LA1_;
	LA14_: ;
...
static TNimNode* TM_jvWQYw9bcuYhftfPX2ynPeg_3[3];
...
TM_jvWQYw9bcuYhftfPX2ynPeg_3[0] = &TM_jvWQYw9bcuYhftfPX2ynPeg_0[1];
...
TM_jvWQYw9bcuYhftfPX2ynPeg_3[1] = &TM_jvWQYw9bcuYhftfPX2ynPeg_0[2];
...
TM_jvWQYw9bcuYhftfPX2ynPeg_3[2] = &TM_jvWQYw9bcuYhftfPX2ynPeg_0[3];
...
TM_jvWQYw9bcuYhftfPX2ynPeg_0[0].len = 3; TM_jvWQYw9bcuYhftfPX2ynPeg_0[0].kind = 2; TM_jvWQYw9bcuYhftfPX2ynPeg_0[0].sons = &TM_jvWQYw9bcuYhftfPX2ynPeg_3[0];

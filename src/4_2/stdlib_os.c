...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_5, "/proc/", 6);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_6, "/path/a.out", 11);
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7), ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
				while (1) {
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir_V86QyZrcGMPX0W9bv1Q53ww_2)(NimStringDesc* dir) {
	...
	LA6_: ;
	{
		...
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T9_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4));
	}
	LA1_: ;
	return result;
}

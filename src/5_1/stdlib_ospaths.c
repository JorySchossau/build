	...
	NimTV_ = (NimThreadVars*) GetThreadLocalVars();
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				T13_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len++;
				T14_ = (NimStringDesc*)0;
				T14_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T13_]; NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T13_] = copyStringRC1(T12_);

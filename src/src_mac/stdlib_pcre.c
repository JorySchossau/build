...
tyProc_hMR3nXvmHGbyZzcDul78bg Dl_276758_;
...
tyProc_urwqljFnOeCDcw8gOFcrpg Dl_276697_;
STRING_LITERAL(TM_9c4KgWyI7MBUp1bOanYigOw_5, "libpcre.3.dylib", 15);
STRING_LITERAL(TM_9c4KgWyI7MBUp1bOanYigOw_7, "libpcre.1.dylib", 15);
STRING_LITERAL(TM_9c4KgWyI7MBUp1bOanYigOw_9, "libpcre.dylib", 13);
STRING_LITERAL(TM_9c4KgWyI7MBUp1bOanYigOw_10, "libpcre(.3|.1|).dylib", 21);
...
||(TM_9c4KgWyI7MBUp1bOanYigOw_3 = nimLoadLibrary(((NimStringDesc*) &TM_9c4KgWyI7MBUp1bOanYigOw_9)))
	...
	Dl_276691_ = (tyProc_5cp59bim9aJ4WupX5aVaD1Sg) nimGetProcAddr(TM_9c4KgWyI7MBUp1bOanYigOw_3, "pcre_free_substring");
	Dl_276758_ = (tyProc_hMR3nXvmHGbyZzcDul78bg) nimGetProcAddr(TM_9c4KgWyI7MBUp1bOanYigOw_3, "pcre_free_study");
	Dl_276601_ = (tyProc_OMNNRjh8IIE9bAc9btZcg0NA) nimGetProcAddr(TM_9c4KgWyI7MBUp1bOanYigOw_3, "pcre_compile");
	Dl_276623_ = (tyProc_KqPl2ltkjnSoyb04zAVCAQ) nimGetProcAddr(TM_9c4KgWyI7MBUp1bOanYigOw_3, "pcre_config");
	Dl_276750_ = (tyProc_qU2uMIyWirSwn1Nd4hJjDw) nimGetProcAddr(TM_9c4KgWyI7MBUp1bOanYigOw_3, "pcre_study");
	Dl_276697_ = (tyProc_urwqljFnOeCDcw8gOFcrpg) nimGetProcAddr(TM_9c4KgWyI7MBUp1bOanYigOw_3, "pcre_fullinfo");
}

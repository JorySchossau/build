		...
		i = ((NI) 0);
		{
			while (1) {
				...
				NimStringDesc* T15_;
				{
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = eqeq__9ccNWqrTIE9bcAqE2Q0ro7zgnre(gEnv[(i)- 0], NIM_NIL);
					if (!T10_) goto LA11_;
					goto LA6;
				}
				LA11_: ;
				...
				T14_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len++;
				T15_ = (NimStringDesc*)0;
				T15_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T14_]; NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T14_] = copyStringRC1(T13_);
...
{	NimTV_ = (NimThreadVars*) GetThreadLocalVars();
	...
	i = findEnvVar_OdjDnFMcplzhh1VlKmvieg(key);
	{
		...
		result = copyStr(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[i], (NI)(T5_ + ((NI) 1)));
		goto BeforeRet_;
	}
	goto LA1_;
	LA3_: ;
	{
		...
		env = getenv(key->data);
		{
			NIM_BOOL T9_;
			T9_ = (NIM_BOOL)0;
			T9_ = eqeq__9ccNWqrTIE9bcAqE2Q0ro7zgnre(env, NIM_NIL);
			if (!T9_) goto LA10_;
...
appendString(T7_, val);
	...
	LA1_: ;
	{
		...
		NI32 T16_;
		T13_ = (int)0;
		T13_ = putenv(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[indx]->data);

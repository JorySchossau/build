...
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_7, "HOME", 4);
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				NimStringDesc* T14_;
				{
					NIM_BOOL T9_;
					T9_ = (NIM_BOOL)0;
					T9_ = eqeq__9ccNWqrTIE9bcAqE2Q0ro7zgnre(environ[(i)- 0], NIM_NIL);
					if (!T9_) goto LA10_;
					goto LA5;
				}
				LA10_: ;
...
{	result = (NimStringDesc*)0;
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_7), ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_4));
